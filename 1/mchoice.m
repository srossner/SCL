...
% --- Main function ---
function next = mchoice(ng, i, j, m, n)
%m,n stores the previous to previous and previous choices of computer
%respectively
% machine and human next move
...
if(ng == 1)
    ...
    samplem2 = updatesamplem(m,n,samplem2);
